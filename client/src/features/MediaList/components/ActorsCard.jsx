...
export const ActorsCard = ({ actor }) => {
  ...
  return (
    <div className="relative flex items-center justify-center  transition-all hover:scale-95 cursor-pointer">
      ...
      />
      <p className="absolute h-24 w-24 mx-auto text-xs text-white font-semibold hover:bg-black/80 opacity-0 hover:opacity-100 rounded-full transition-all border-green-500 border-2 flex items-center justify-center">
        {actor.name}
      </p>
    </div>
  );
