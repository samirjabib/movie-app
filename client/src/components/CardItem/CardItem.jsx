...
export const CardItem = ({movie}) => {
    ...
    return(
            <div className="mt-2 h-full relative" >
                ...
                <div
                    className="absolute top-0 left-0 w-full h-full  transition-all duration-200 hover:bg-white/80
                    dark:hover:bg-black/80  opacity-0 hover:opacity-100  text-black dark:text-white flex flex-col 
                    justify-end"
                >
